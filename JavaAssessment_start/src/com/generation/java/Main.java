...
public class Main {
    ...
    public static void main(String[] args)
        ...
        do {
            try {
                ...
                System.out.println("Invalid input. Please enter number 1 to 8.");
            }
        }
        while (option != 8);
    }
    ...
    private static void gradeStudent(StudentService studentService, Scanner scanner) {
        ...
        System.out.println("Insert course grade for: " + course);
...
//        student.setGrade(course, grade);
    ...
    private static void showPassedCourses(StudentService studentService, Scanner scanner) {
        ...
        System.out.println("Enrolled students with passed courses:");
